<div style="font-family:Arial,sans-serif;max-width:640px;margin:0 auto;color:#17221f;line-height:1.5">
  ...
  <h1 style="margin:0 0 12px;color:#084e87;font-size:28px">Your Health &amp; Safety Healthcheck</h1>
  ...
  <table role="presentation" style="width:100%;border-collapse:separate;border-spacing:8px 0;margin:0 -8px 22px">
    <tr>
      <td style="width:33.33%;padding:14px;border:1px solid #dce6e2;border-radius:8px;background:#f6fafe;text-align:center">
        <strong style="display:block;color:#084e87;font-size:24px"><?php echo (int) $data['summary']['priority_count']; ?></strong>
        <span style="font-size:13px;color:#40544d">Priority actions</span>
      </td>
      <td style="width:33.33%;padding:14px;border:1px solid #dce6e2;border-radius:8px;background:#f6fafe;text-align:center">
        <strong style="display:block;color:#084e87;font-size:24px"><?php echo (int) $data['summary']['review_count']; ?></strong>
        <span style="font-size:13px;color:#40544d">Reviews recommended</span>
      </td>
      <td style="width:33.33%;padding:14px;border:1px solid #dce6e2;border-radius:8px;background:#f6fafe;text-align:center">
        <strong style="display:block;color:#084e87;font-size:24px"><?php echo (int) $data['summary']['addressed_count']; ?></strong>
  ...
  <p style="margin:0 0 24px">
    <a href="<?php echo esc_url($reportUrl); ?>" style="display:inline-block;padding:12px 18px;border-radius:8px;background:#084e87;color:#ffffff;text-decoration:none;font-weight:700">View your secure report</a>
  </p>
