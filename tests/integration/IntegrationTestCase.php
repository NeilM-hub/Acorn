...
{
 protected function setUp():void{parent::setUp();Schema::install();global$wpdb;foreach(['answers','assessments','contacts','recommendations','questions','content_versions']as$table)$wpdb->query('TRUNCATE TABLE '.Schema::table($table));SeedContent::installIfEmpty();}
